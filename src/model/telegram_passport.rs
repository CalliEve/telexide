...
pub struct PassportData {
    /// Vec with information about documents and other Telegram Passport elements that was shared with the bot
...
pub struct EncryptedPassportElement {
    ...
    ///
    /// [PassportElementErrorUnspecified]: ../api/types/struct.PassportElementErrorUnspecified.html
    pub hash: String
}
