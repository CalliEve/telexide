...
/// This macro creates the [`Framework`] object using the given bot name and registers all the given commands on it.
/// call it as in `create_framework!("bot_name", command1, command2, ...)`
///
